  ...
  rules: [
    {
      ...
      checkFunction: (content, lines, filePath) => {
        ...
        if (hasModal) {
          const hasFocusManagement = content.includes('useEffect') &&
    ...
    
    {
      ...
      shouldCheck: (relativePath) => {
        return relativePath.includes('layout') || 
      ...
      checkFunction: (content, lines, filePath) => {
        ...
        const hasSkipLink = content.includes('#main-content') ||
                           content.includes('#skip') ||
                           content.includes('Skip to');
        
        const isLayoutFile = content.includes('<main') || 
