        ...
        <Grid item xs={12} lg={6}>
          ...
          >
            ...
            <Typography variant='body2' color='text.secondary' sx={{ mb: 3 }}>
              Enter a GitHub repository URL to run a comprehensive audit. The results will
              be automatically pushed to your repository.
            </Typography>
            <AuditForm />
          </Paper>
        </Grid>
          ...
          <Grid item xs={12} md={4}>
            <Paper sx={{ p: 3, textAlign: 'center', height: '100%' }}>
              ...
              <Typography variant='body2' color='text.secondary'>
                Analyzes Next.js architecture, MUI usage, accessibility, performance, and
                security
              </Typography>
            </Paper>
          </Grid>
